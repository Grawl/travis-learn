...
# It will build your project using your build process, and if there will be any changes, it will push them into your repository as a commit. Basically, this script will push any added files added or removed by your build process.
...
# Let's go back from Travis auto-generated branch to target branch for publishing
